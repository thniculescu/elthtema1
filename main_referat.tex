...
\input{symbols/romanianCircuitSymbols.tex}
...
\input{tex_files/cuprins}  % fisierul principal nu include textul propriu-zis al documentului
...
%\bibliography{referinte_exemplu}  % in pachetul de fisiere existafisierul referinte_exemplu.bib

\newpage
%\begin{appendix}
%\input{tex_files/anexe}
%\end{appendix}
